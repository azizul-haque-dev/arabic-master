...
import { deleteWord, fetchWords } from "../words/api";
import { WordFormDialog } from "../words/word-form-dialog";
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This word will be permanently deleted, including its category
              tags.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
